...
export default class PostCategoryController {
    ...
    async createPostCategory(req: Request<{},{},CreatePostCategoryPayloadDTOType>, res: Response) {
    ...
    async updatePostCategory(req: Request<{id: number}, {}, UpdatePostCategoryPayloadDTOType>, res: Response) {
